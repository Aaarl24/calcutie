window.onload=()=>{
    ...
    themeToggle.addEventListener('change', () => {
        ...
        themeToggle.checked ? "Change Theme" : "Change Theme";
    });
    ...
    buttons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            if (value === 'AC') {
                ...
                if (!['+', '-', '*', '/'].includes(lastInput)) { expression += value;
                }
            } else if (value === '%') {
            ...
            if  (expression.length > 10 || result.length > 10) { expressionDisplay.classList.add('long');
                resultDisplay.classList.add('long');
            } else { expressionDisplay.classList.remove('long');
